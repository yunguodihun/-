package com.itssky.modules.common.core.utils.sign;
...
public final class Base64
{
    ...
    static
    {
        ...
        for (@SuppressWarnings("AlibabaUndefineMagicConstant") int i = 'Z'; i >= 'A'; i--)
        {
        ...
        //noinspection AlibabaUndefineMagicConstant
        for (@SuppressWarnings("AlibabaUndefineMagicConstant") int i = '9'; i >= '0'; i--)
        {
        ...
        //noinspection AlibabaUndefineMagicConstant
        for (@SuppressWarnings("AlibabaUndefineMagicConstant") int i = 26, j = 0; i <= 51; i++, j++)
        {
            LOOK_UP_BASE64_ALPHABET[i] = (char) ('a' + j);
        }

        //noinspection AlibabaUndefineMagicConstant
        for (@SuppressWarnings("AlibabaUndefineMagicConstant") int i = 52, j = 0; i <= 61; i++, j++)
        {
