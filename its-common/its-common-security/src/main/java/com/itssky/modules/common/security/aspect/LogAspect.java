package com.itssky.modules.common.security.aspect;

import com.alibaba.fastjson.JSON;
import com.itssky.modules.common.core.enums.HttpMethod;
...
import com.itssky.modules.common.security.enums.BusinessStatus;
...
public class LogAspect
{
     ...
     * 配置织入点
     */
    @Pointcut("@annotation(com.itssky.modules.common.security.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult)
    {
        try
        {
            ...
            // 获取当前的用户
            LoginUser loginUser = SpringUtils.getBean(TokenUtil.class).getLoginUser(ServletUtils.getRequest());
