package com.itssky.modules.system.utils;

import com.itssky.modules.common.core.annotation.Excel;
import com.itssky.modules.common.core.annotation.Excel.ColumnType;
import com.itssky.modules.common.core.annotation.Excel.Type;
...
import com.itssky.modules.common.core.utils.reflect.ReflectUtils;
...
public class ExcelDictUtil<T>
{
    private static final Logger log = LoggerFactory.getLogger(ExcelDictUtil.class);
    ...
    public ExcelDictUtil(Class<T> clazz)
    {
        this.clazz = clazz;
    }
            ...
            for (int i = 1; i < rows; i++)
            {
                ...
                for (Map.Entry<Integer, Field> entry : fieldsMap.entrySet())
                {
                    ...
                    if (StringUtils.isNotNull(fieldType))
                    {
                        ...
                        {
                            propertyName = field.getName() + POINT + attr.targetAttr();
                        }
